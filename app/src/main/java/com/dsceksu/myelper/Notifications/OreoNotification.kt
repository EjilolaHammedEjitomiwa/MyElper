...
class OreoNotification(base: Context) : ContextWrapper(base) {
    ...
    companion object {
        private const val CHANNEL_ID = "com.dsceksu.myelper"
        private const val CHANNEL_NAME = "OMES"
    }
    ...
    @TargetApi(Build.VERSION_CODES.O)
   fun getOreoNotification(title:String?, body:String?, pendingIntent:PendingIntent?,soundUri:Uri?):Notification.Builder{
        val yaseerDosariImage = BitmapFactory.decodeResource(applicationContext.resources, R.drawable.ic_launcher_foreground)
